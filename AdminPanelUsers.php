...
<html>
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="../HTML/AdminPanelUsers.php" class="active"><i class="fa fa-users" aria-hidden="true" style="color:black"></i> 
                        <span>users</span></a>
                    </li>
      ...
      <?php 
                ...
                $select= "SELECT user_id,user_fname,user_lname,email from users_details"; 
